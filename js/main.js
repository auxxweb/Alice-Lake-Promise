...
function showToast() {
	...
	if (toast) {
	  ...
	  setTimeout(function() {
		// Remove the class name after 3 seconds
...
$(document).ready(function () {
  $('#contactform').submit((e) => {
	...
	// validateInput("subject", "subjectError");
	validateInput("message", "messageError");



	// Check if all fields have values
	// if (!name || !email || !phoneNumber || !message) {
	//   alert(`Please fill ${name ? name : ''} ${email ? email : ''} ${phoneNumber ? phoneNumber : ''} ${message ? message : ''} fields.`);
	//   return;
	// }
